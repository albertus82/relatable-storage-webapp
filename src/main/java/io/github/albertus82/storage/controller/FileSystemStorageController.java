...
import io.github.albertus82.storage.service.FileSystemStorageService;
...
@RestController
@RequestMapping("/api/v1/storage/fs")
@Validated
@Secured(RW)
public class FileSystemStorageController {
	...
	@Autowired
	public FileSystemStorageController(FileSystemStorageService storageService, @Value("${relatable-storage.content-disposition:attachment}") @NonNull String contentDisposition) {
